      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold">TravelEase</h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-2">
                <Globe className="h-5 w-5 mt-0.5 text-gray-300" />
                <span className="text-gray-300">123 Travel Street, Adventure City</span>
              </li>
              <li className="flex items-center space-x-2">
                <Mail className="h-5 w-5 text-gray-300" />
                <a href="mailto:info@travelease.com" className="text-gray-300 hover:text-white transition-colors">
                  info@travelease.com
                </a>
              </li>
              <li className="flex items-center space-x-2">
